...
<DIV id=header class=wrap>
  <DIV id=logo><IMG src="../images/logo1.gif" width="193" height="74"></DIV></DIV>
          ...
          <TABLE class=field>
            ...
            <TR>
              ...
              <TD><INPUT class=text type=date name=pubdate
               value="<fmt:formatDate value="${h.pubdate}" pattern="yyyy-MM-dd"></fmt:formatDate> "></TD></TR>
            <TR>
            ...
            <TR>
              ...
              <TD>
                <img src="http://localhost:81/${h.path}" alt="" height="50" width="50" />
