...
<DIV id=navbar class=wrap>
    <DL class="search clearfix">
        <FORM id=sform method=post action=searchHouse>
            ...
            标题：<input type="text" class="text" name="title" value="${condition.title}"/>
            ...
            价格:<input type="tex" name="startPrice" size="8" value="${condition.startPrice}">
            -<input name="endPrice" type="text" size="8" value="${condition.endPrice}">
