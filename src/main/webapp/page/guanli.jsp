  ...
  <DIV id=houseArea>
    <TABLE class=house-list>
      ...
      <c:forEach items="${pageInfo.list}" var="h">
        <TR>
          <TD class=house-thumb><SPAN><A href="/page/getOneHouse?id=${h.id}" target="_blank"><img src="http://localhost:81/${h.path}" width="100" height="75" alt=""></A></SPAN></TD>
          <TD>
            <DL>
              <DT><A href="/page/getOneHouse?id=${h.id}" target="_blank">${h.title}</A></DT>
